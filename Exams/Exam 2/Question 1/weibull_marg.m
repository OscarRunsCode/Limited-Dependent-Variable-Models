% Octave function that estimates marginal effects in a Weibull model -
...
% sample means of the regressors, and d is the vector of Weibull 
...
function weibull_marg(data,dep,ind,beta); 
clc
...
fprintf('weibull Marginal Effects - The dependent variable is: %s\n',dep);
...
[d,vc,md]=weibull_bhhh(beta);           % Compute VC matrix of coefficients.
